...
namespace Financeasy.Api.Persistence.Mappings
{
    public class CustomerMapping : EntityTypeConfiguration<Customer>
    {
        public CustomerMapping()
        {
            ...
            Property(x => x.CPF).HasColumnName("CPF").HasColumnType("varchar").HasMaxLength(14).IsRequired();
            Property(x => x.CNPJ).HasColumnName("CNPJ").HasColumnType("varchar").HasMaxLength(18).IsRequired();
            Property(x => x.Email).HasColumnName("Email").HasColumnType("varchar").HasMaxLength(200).IsRequired();
            Property(x => x.HomePhone).HasColumnName("HomePhone").HasColumnType("varchar").HasMaxLength(15).IsRequired();
            Property(x => x.CommercialPhone).HasColumnName("CommercialPhone").HasColumnType("varchar").HasMaxLength(15).IsRequired();
            Property(x => x.CellPhone).HasColumnName("CellPhone").HasColumnType("varchar").HasMaxLength(15).IsRequired();
